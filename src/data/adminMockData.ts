  ...
  return {
    ...
    cloudServices: {
      slb: {
        ...
        packetLossRate: 0.02,
        errorCount: 12,
        inboundBandwidth: 156.8,
        outboundBandwidth: 234.5,
        maxBandwidth: 500,
      },
      servers: [
        {
          ...
          cpuUser: 45.2,
          cpuSystem: 12.8,
          memoryAvailable: 12.4,
          memoryTotal: 32,
          loadAverage: [2.1, 1.8, 1.5] as [number, number, number],
          diskReadSpeed: 125.6,
          diskWriteSpeed: 89.3,
          diskIoWait: 3.2,
          diskUsageRoot: 62.5,
        ...
        },
        {
          ...
          cpuUser: 38.6,
          cpuSystem: 10.2,
          memoryAvailable: 15.8,
          memoryTotal: 32,
          loadAverage: [1.6, 1.4, 1.2] as [number, number, number],
          diskReadSpeed: 98.4,
          diskWriteSpeed: 67.2,
          diskIoWait: 2.1,
          diskUsageRoot: 55.2,
        ...
        },
        {
          ...
          memoryAvailable: 6.2,
          memoryTotal: 32,
          loadAverage: [4.2, 3.8, 3.2] as [number, number, number],
          diskReadSpeed: 185.6,
          diskWriteSpeed: 142.8,
          diskIoWait: 8.5,
          diskUsageRoot: 78.5,
          diskUsageLogs: 85.2,
          networkInbound: 78.6,
          networkOutbound: 95.4,
        },
      ],
      database: {
        ip: '10.0.3.20',
